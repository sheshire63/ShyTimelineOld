...
var timeline_editor: Control = load("res://addons/ShyTimeline/Editor/TimelineEditor.tscn").instantiate()
...
func _enter_tree() -> void:
	get_editor_interface().get_editor_main_control().add_child(timeline_editor)
	for i in autoloads:
